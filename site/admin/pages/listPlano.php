...
<div class="row">
    ...
    <form action="listPlano.php" method="post">
        ...
        <table class="table table-striped table-hover align-middle">
            ...
            <tbody>
                ...
                foreach ($dados as $item) {
                    ...
                    <td class='text-center'>
                        <a class='btn btn-danger btn-sm' title='Deletar' onclick='return confirm(\"Tem certeza que deseja deletar este usuário?\")' href='listPlano.php?id=$item->id'>Deletar</a>
                    </td>   
                </tr>";
                }
                ?>

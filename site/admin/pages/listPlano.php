        ...
        <div class="row align-items-end g-3">
            <div class="col-md-3">
                ...
                <select name="tipo" class="form-select border-2">
                    <option value="nome_plano" <?php echo (isset($_POST['tipo']) && $_POST['tipo'] == 'nome_plano') ? 'selected' : 'all'; ?> selected>Nome do Plano</option>
                        ...
                        <?php foreach ($dados as $item): ?>
                            <tr>
                                ...
                                <td class="text-success fw-semibold">
                                    R$ <?php echo number_format((float)$item->preco_mensal, 2, ',', '.'); ?>
                                </td>

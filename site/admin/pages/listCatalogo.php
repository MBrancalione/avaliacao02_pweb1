        ...
        <div class="row align-items-end g-3">
            <div class="col-md-3">
                ...
                <select name="tipo" class="form-select border-2">
                    <option value="id" <?php echo (isset($_POST['tipo']) && $_POST['tipo'] == 'id') ? 'selected' : ''; ?>>ID</option>  <!--o cmapo tipo foi enviado via form? & o valor selcionado pelo usuario é igual o id?-->
                    <option value="titulo" <?php echo (isset($_POST['tipo']) && $_POST['tipo'] == 'titulo') ? 'selected' : ''; ?> selected>Título</option>
